...
HierarchicalMatrix<datatype,dim>& HierarchicalMatrix<datatype,dim>::invert(){

    HierarchicalMatrix<> HierachlMatrix; //Konstruktor???
    ...
    //Alles noch nicht kompeliert und nicht funktionsfähig, da mir noch folgende Dinge fehlen:
    // - Operator Multiplikation
    // - Operator Addition
    // - Operator Subtraktion
    // - Konstruktor von den Hierarischen Matrizen
